 ...
 * Elementor Clients
 *
 * Elementor widget for Clients Showcase
 *
 * @since 1.0.0
 */
class Pando_Clients extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pando Clients', 'pando-extra' );
	}
	...
	protected function render() {
		...
		<div class="pando-clients">
			<?php echo do_shortcode('[pando-clients-carousel]'); ?>
		</div>
